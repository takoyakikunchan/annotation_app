...
また、特に現在、日本、アメリカ、韓国のプロデューサーに対するファンの注目は高まっているものの、プロデューサーやトラックメイカーに関する情報にネット上で簡単にアクセスするこユーザーによって編集を重ねることができるプロデューサーのマイページを作成しました。
...
この機能によって、「ユーザーの抱いている感想の動向を可視化する」ことができます。
